...
public class ImportProjectAndSensorConfigs extends Operation {
    ...
    protected boolean onExecute() {
        ...
        //debug
        //simulateImportProjectConfigsAndSensorConfigs2();

        return true;
    }

    private void simulateImportProjectConfigsAndSensorConfigs2() {
        ...
        ScoutMissionConfig missionConfig1 = new ScoutMissionConfig("告警信息测试1");
        missionConfig1.setDescription("其中的测量参数均由实际传感器通过wifi提供");
        missionConfig1.setDeviceImageData(getBitmap(R.drawable.ic_actionbar_setting));
        ScoutMissionConfig missionConfig2 = new ScoutMissionConfig("告警信息测试2");
        missionConfig2.setDescription("其中的测量参数均由实际传感器通过wifi提供");
        missionConfig2.setDeviceImageData(getBitmap(R.drawable.ic_actionbar_datamode));
        ScoutMissionConfig missionConfig3 = new ScoutMissionConfig("告警信息测试3");
        missionConfig3.setDescription("其中的测量参数均由实际传感器通过wifi提供");
        missionConfig3.setDeviceImageData(getBitmap(R.drawable.ic_dialog_loading));
        ...
        ScoutItemConfig itemConfigWD = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigWSD = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigMC = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigBleWD = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigBleMC = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigBleZljsdX = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigBleZljsdY = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        ScoutItemConfig itemConfigBleZljsdZ = new ScoutItemConfig(IdentifierGenerator.get64());
        ...
        missionConfig1.getItems().add(itemConfigWD);
        missionConfig2.getItems().add(itemConfigWSD);
        missionConfig2.getItems().add(itemConfigMC);
        missionConfig2.getItems().add(itemConfigBleWD);
        missionConfig2.getItems().add(itemConfigBleMC);
        missionConfig3.getItems().add(itemConfigBleZljsdX);
        missionConfig3.getItems().add(itemConfigBleZljsdY);
        missionConfig3.getItems().add(itemConfigBleZljsdZ);
        projectConfig1.getMissions().add(missionConfig1);
        projectConfig1.getMissions().add(missionConfig2);
        projectConfig1.getMissions().add(missionConfig3);
    ...
    private void simulateImportProjectConfigsAndSensorConfigs1() {
        List<ScoutProjectConfig> projectConfigs = new ArrayList<>();
        List<ScoutSensorConfig> sensorConfigs = new ArrayList<>();
        ScoutProjectConfig projectConfig1 = new ScoutProjectConfig("巡检项目1");
        projectConfig1.setDescription("这是巡检项目1");
