package com.example.kat.pollinghelper.bean;
...
public class QueryInfo {
    ...
    //projectConfig可以通过List<ScoutProjectConfig> projectConfigs = (List<ScoutProjectConfig>)getValue(ArgumentTag.AT_LIST_PROJECT_CONFIG)得到
    ...
    public QueryInfo setProjectRecordNames(List<ScoutProjectConfig> projectConfigs) {
